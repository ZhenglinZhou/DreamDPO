...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if pretrained:
            ...
            if os.path.isfile(checkpoint_local_path):
...
def create_model_and_transforms(
    ...
    if with_region_predictor:
        ...
        model.region_predictor = torch.nn.Linear(model.visual.proj.size(0), 1).to(device=device,
                                                                                  dtype=model.visual.proj.dtype)
